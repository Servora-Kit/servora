...
func (_q *DictItemQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *DictItemQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *DictItemQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *DictItemQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *DictItemQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *DictItemQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(dictitem.FieldDictTypeID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.DictItem.Query().
//		Select(dictitem.FieldDictTypeID).
//		Scan(ctx, &v)
...
func (_q *DictItemQuery) loadDictType(ctx context.Context, query *DictTypeQuery, nodes []*DictItem, init func(*DictItem), assign func(*DictItem, *DictType)) error {
	...
	nodeids := make(map[uuid.UUID][]*DictItem)
	for i := range nodes {
...
func (_q *DictItemQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(dictitem.Table, dictitem.Columns, sqlgraph.NewFieldSpec(dictitem.FieldID, field.TypeUUID))
	_spec.From = _q.sql
