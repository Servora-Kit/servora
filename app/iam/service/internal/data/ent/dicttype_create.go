...
func (_c *DictTypeCreate) SetSort(v int) *DictTypeCreate {
	_c.mutation.SetSort(v)
	return _c
}

// SetNillableSort sets the "sort" field if the given value is not nil.
func (_c *DictTypeCreate) SetNillableSort(v *int) *DictTypeCreate {
	if v != nil {
		_c.SetSort(*v)
	}
	return _c
...
func (_c *DictTypeCreate) SetID(v uuid.UUID) *DictTypeCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *DictTypeCreate) SetNillableID(v *uuid.UUID) *DictTypeCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *DictTypeCreate) AddItemIDs(ids ...uuid.UUID) *DictTypeCreate {
	_c.mutation.AddItemIDs(ids...)
	return _c
}

// AddItems adds the "items" edges to the DictItem entity.
func (_c *DictTypeCreate) AddItems(v ...*DictItem) *DictTypeCreate {
...
func (_c *DictTypeCreate) check() error {
	...
	if _, ok := _c.mutation.Sort(); !ok {
		return &ValidationError{Name: "sort", err: errors.New(`ent: missing required field "DictType.sort"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
...
func (_c *DictTypeCreate) createSpec() (*DictType, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(dicttype.Table, sqlgraph.NewFieldSpec(dicttype.FieldID, field.TypeUUID))
	)
