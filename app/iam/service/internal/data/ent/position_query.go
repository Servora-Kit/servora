...
func (_q *PositionQuery) QueryTenant() *TenantQuery {
...
func (_q *PositionQuery) QueryOrganization() *OrganizationQuery {
...
func (_q *PositionQuery) WithTenant(opts ...func(*TenantQuery)) *PositionQuery {
	query := (&TenantClient{config: _q.config}).Query()
...
func (_q *PositionQuery) WithOrganization(opts ...func(*OrganizationQuery)) *PositionQuery {
	query := (&OrganizationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PositionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Position, error) {
	...
	if query := _q.withTenant; query != nil {
		if err := _q.loadTenant(ctx, query, nodes, nil,
			func(n *Position, e *Tenant) { n.Edges.Tenant = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withOrganization; query != nil {
		if err := _q.loadOrganization(ctx, query, nodes, nil,
			func(n *Position, e *Organization) { n.Edges.Organization = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PositionQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*Position, init func(*Position), assign func(*Position, *Tenant)) error {
...
func (_q *PositionQuery) loadOrganization(ctx context.Context, query *OrganizationQuery, nodes []*Position, init func(*Position), assign func(*Position, *Organization)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Position)
	for i := range nodes {
...
func (_q *PositionQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withTenant != nil {
			_spec.Node.AddColumnOnce(position.FieldTenantID)
		}
		if _q.withOrganization != nil {
			_spec.Node.AddColumnOnce(position.FieldOrganizationID)
		}
	}
